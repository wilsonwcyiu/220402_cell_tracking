...
def main():
    ...
    fig, axes = plt.subplots(
        nrows=6,
        ncols=6,
        figsize=(50, 50),  # 512 x 512 pixels at dpi=100
        dpi=100
    )
    ...
    for pkl_file_name in pkl_file_name_list:
        ...
        for measurement_input in measurement_input_list:
            ...
            create_ttest_plot(axes, fig_pos_x, fig_pos_y, data_list, label_list, measurement_type, sig_label)
...
def create_ttest_plot(axis_plot, sub_plot_x, sub_plot_y, data_list, label_list, measurement_type, sig_label):
    ...
    # 设置标签和标题
    axis_plot[sub_plot_x, sub_plot_y].set_title("Distant neutrophils - " + measurement_type + "\n\n" + sig_label, fontsize=32, weight='bold')

    axis_plot[sub_plot_x, sub_plot_y].set_xticks([0, 1], label_list, fontsize=32, weight='bold')
    axis_plot[sub_plot_x, sub_plot_y].set_ylabel(measurement_type + " (μm/min)", fontsize=32, weight='bold')
