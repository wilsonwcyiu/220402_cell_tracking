    ...
    for series in existing_series_list:
        ...
        for track_tuple_list_list in series_viterbi_result_list_dict[series]:
            ...
            for track_tuple_list in track_tuple_list_list:
                ...
                prob_data = ProbabilityData(series, frame_num-1, previous_node, current_node, prob)
                prob_data_list.append(prob_data)
        ...
        for prob_data in prob_data_list:
            print(prob_data.series, prob_data.probability, prob_data.frame_num, prob_data.from_node_idx, prob_data.to_node_idx)
        print()
