...
hungarian_results_dict = open_track_dictionary(save_dir + "viterbi_adjust4e_hp017.pkl")
...
meanvalue = np.round(meanvalue, 4)
print("meanvalue FIT", meanvalue[0:4])
print("meanvalue FIO", meanvalue[4:8])
print("meanvalue TP ", meanvalue[8:12])
print("meanvalue OP ", meanvalue[12:16])
print("meanvalue avg length", meanvalue[16:20])
