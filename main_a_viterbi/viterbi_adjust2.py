...
segmentation_folder = 'F://viterbi linkage//dataset//segmentation_unet_seg//'
images_folder = 'F://viterbi linkage//dataset//images//'
output_folder = 'F://viterbi linkage//dataset//output_unet_seg_finetune//'
...
def save_track_dictionary(dictionary, save_file):
    ...
    pickle_out.close()    
save_dir ='F://viterbi linkage//dataset//save_directory//' 
print(save_dir)
